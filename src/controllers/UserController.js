...
var UserController = /** @class */ (function () {
    ...
    UserController.prototype.create = function (req, res) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, email, password, role, passwordEncrypted, newUSer, error_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        passwordEncrypted = _b.sent();
                        newUSer = userRepository_1.userRepository.create({ email: email, password: passwordEncrypted, role: role });
